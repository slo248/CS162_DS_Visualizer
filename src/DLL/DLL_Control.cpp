...
DLL_Control::DLL_Control(sf::Font *font, sf::Vector2f windowSize): 
    Control(font)
{
...
void DLL_Control::genOptions(sf::Vector2f windowSize)
{
...
void DLL_Control::genSuboptions(sf::Vector2f windowSize)
{
    // create
