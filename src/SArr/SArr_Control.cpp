...
SArr_Control::SArr_Control(sf::Font *font, sf::Vector2f windowSize): 
    Control(font)
{
...
void SArr_Control::genOptions(sf::Vector2f windowSize)
{
...
void SArr_Control::genSuboptions(sf::Vector2f windowSize)
{
    // create
