...
CLL_Control::CLL_Control(sf::Font *font, sf::Vector2f windowSize): 
    Control(font)
{
...
void CLL_Control::genOptions(sf::Vector2f windowSize)
{
...
void CLL_Control::genSuboptions(sf::Vector2f windowSize)
{
    // create
