...
struct Node
{
    ...
    void drawCircleMove(sf::RenderWindow* window, sf::Vector2f src, float alpha, float beta, sf::CircleShape* circle, sf::Color inColor, sf::Color outColor, sf::Text* num, sf::Color numColor, float percent);
    //
    ...
    void drawSquareMove(sf::RenderWindow* window, sf::Vector2f src, float alpha, float beta, sf::RectangleShape* square, sf::Color inColor, sf::Color outColor, sf::Text* num, sf::Color numColor, float percent);
    //
