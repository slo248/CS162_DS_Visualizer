...
struct Node
{
    ...
    void drawCircleMoveAngle(sf::RenderWindow* window, sf::Vector2f src, sf::Vector2f origin, float alpha, float beta, sf::CircleShape* circle, sf::Color inColor, sf::Color outColor, sf::Text* num, sf::Color numColor, float percent);
    //
    ...
    void drawSquareMoveAngle(sf::RenderWindow* window, sf::Vector2f src, sf::Vector2f origin, float alpha, float beta, sf::RectangleShape* square, sf::Color inColor, sf::Color outColor, sf::Text* num, sf::Color numColor, float percent);
    //
